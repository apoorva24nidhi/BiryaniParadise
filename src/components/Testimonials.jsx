...
const Testimonials = () => {
  return (
    <div id='test' className="items-center w-full relative md:p-10 p-2">
        ...
        <div className='md:p-4 p-1 md:flex'>
          ...
          <div className="md:p-4 p-1 rounded text-black md:w-[600px] w-[320px]">
            <div className='bg-pink-100 md:h-[240px] h-[200px]'>
              ...
              <p className='md:p-4 p-4 text-yellow-500 md:text-2xl text:-lg flex'>
              ...
              <p className='md:p-4 p-4 md:text-sm text-xs'>
